...
#Shift left in the byte, with 0 in the low bit
...
def encrypt_block(block, roundkeys):
    ...
    for i in range(1, 10):
        ...
        add_round_key(plain_state, roundkeys[4 * i : 4 * (i + 1)])
...
def decrypt_block(block, roundkeys):
    ...
    for i in range(9, 0, -1):
        add_round_key(cipher_state, roundkeys[4 * i : 4 * (i + 1)])
